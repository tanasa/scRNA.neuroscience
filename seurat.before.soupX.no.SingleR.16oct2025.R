...
# Construct the h5 filename
h5_file <- file.path(path, paste0(sample_id, "_sample_filtered_feature_bc_matrix.h5"))
...
p_apoe <- plot_gene_umap_seurat(sce_obj, "APOE")
print(p_apoe)
ggsave(outfn("gene_APOE_umap_violin.png"), plot = p_apoe, width = 12, height = 5, dpi = 300)

p_app <- plot_gene_umap_seurat(sce_obj, "APP")
print(p_app)
ggsave(outfn("gene_APP_umap_violin.png"), plot = p_app, width = 12, height = 5, dpi = 300)

p_psen1 <- plot_gene_umap_seurat(sce_obj, "PSEN1")
print(p_psen1)
ggsave(outfn("gene_PSEN1_umap_violin.png"), plot = p_psen1, width = 12, height = 5, dpi = 300)

p_psen2 <- plot_gene_umap_seurat(sce_obj, "PSEN2")
print(p_psen2)
ggsave(outfn("gene_PSEN2_umap_violin.png"), plot = p_psen2, width = 12, height = 5, dpi = 300)
